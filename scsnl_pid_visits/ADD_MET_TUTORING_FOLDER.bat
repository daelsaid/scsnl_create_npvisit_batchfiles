...
set /p project="Enter the Project Name (asd_met or met):"
if "%project%"=="met" set /p tutoring_group="Enter Subject's tutoring group (spt or vnt):"
...
set /p project2="ENTER PROJECT NAME AGAIN TO CONTINUE (PROJECT NAMES MUST MATCH OR PROGRAM WILL EXIT):"
if "%project%"=="met" set /p tutoring_group2="ENTER TUTORING INTERVENTION (INTERVENTION MUST MATCH PROGRAM WILL EXIT):"
set /p visit2="ENTER VISIT # AGAIN TO CONTINUE (VISITS MUST MATCH OR PROGRAM WILL EXIT):"

ECHO.

if "%pid%" NEQ "%pid2%" GOTO :pid_visit_invalid
if "%project%" NEQ "%project2%" GOTO :pid_visit_invalid
...
if "%project%" == "%project2%" GOTO :continue
...
If "%tutoring_group%" NEQ "%tutoring_group2%" ECHO YOU ENTERED 2 DIFFERENT INTERVENTIONS FOR THE TUTORING GROUP
ECHO YOU ENTERED: %tutoring_group% and %tutoring_group2%, RESTART THE PROGRAM AND ENTER THE CORRECT INTERVENTION
...
if "%project%" == "met" ECHO TUTORING GROUP: %tutoring_group%
ECHO VISIT: %visit%
pause

if "%project%" == "met" set main_tutoring_template_dir=%parent_dir%\project_template_folders\%project%\tutoring_%tutoring_group%
if "%project%" == "asd_met" set main_tutoring_template_dir=%parent_dir%\project_template_folders\%project%\tutoring_spt
